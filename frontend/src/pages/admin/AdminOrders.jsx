...
const statusOptions = [
    ...
    { value: 'shipping', label: 'Shipping', color: 'bg-purple-100 text-purple-700' },
    ...
    return (
        <div className="p-8">
            <div className="mb-8 text-left">
                ...
                <p className="text-gray-500 text-sm mt-1">Total: {orders?.length} orders found</p>
            </div>
                            ...
                            <div key={order._id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
                                ...
                                >
                                    <div className="grid grid-cols-4 gap-8 text-left w-full">
                                        <div>
                                            <p className="text-[10px] uppercase font-bold text-gray-400 mb-1">Order ID</p>
                                        ...
                                        <div>
                                            <p className="text-[10px] uppercase font-bold text-gray-400 mb-1">Amount</p>
                                    ...
                                    <div className="border-t border-gray-100 bg-gray-50/50 p-6">
                                        <div className="grid md:grid-cols-2 gap-8">
                                            ...
                                            <div className="text-left space-y-6">
                                                ...
                                                <div>
                                                    <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Update Order Status</h3>
