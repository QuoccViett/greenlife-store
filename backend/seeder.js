...
const subCategories = [
    { name: 'Bamboo Products', slug: 'bamboo-products', parent: 'eco-home-living' },
    { name: 'Kitchen Tools', slug: 'kitchen-tools', parent: 'eco-home-living' },
    { name: 'Cleaning Supplies', slug: 'cleaning-supplies', parent: 'eco-home-living' },
    { name: 'Skincare', slug: 'skincare', parent: 'personal-care' },
    { name: 'Soap', slug: 'soap', parent: 'personal-care' },
    { name: 'Shampoo Bars', slug: 'shampoo-bars', parent: 'personal-care' },
    { name: 'Tote Bags', slug: 'tote-bags', parent: 'reusable-bags' },
    { name: 'Shopping Bags', slug: 'shopping-bags', parent: 'reusable-bags' },
    { name: 'Straws', slug: 'straws', parent: 'zero-waste' },
    { name: 'Food Wraps', slug: 'food-wraps', parent: 'zero-waste' },
    { name: 'Storage', slug: 'storage', parent: 'zero-waste' },
    { name: 'Water Bottles', slug: 'water-bottles', parent: 'daily-essentials' },
    { name: 'Lunch Boxes', slug: 'lunch-boxes', parent: 'daily-essentials' },
]
...
const seedDB = async () => {
    try {
        ...
        console.log('Cleared all old data (including Suppliers & Purchase Orders)')
        ...
        // 3. Tạo Nhà cung cấp mẫu (Suppliers)
        const suppliers = await Supplier.insertMany([
            {
                name: 'Công ty TNHH Tre Việt (Bamboo Viet)',
                phone: '0988123456',
                email: 'contact@bambooviet.vn',
                address: 'KCN Tân Bình, TPHCM',
                note: 'Chuyên cung cấp đồ dùng từ tre, gỗ tái chế',
                isActive: true
            },
            {
                name: 'Xưởng Sản Xuất Vải Bạt Eco Packaging',
                phone: '0912987654',
                email: 'sales@ecopack.vn',
                address: 'Hóc Môn, TPHCM',
                note: 'Cung cấp túi vải organic, túi lưới',
                isActive: true
            }
        ])
        console.log('Suppliers created:', suppliers.length)

        // 4. Tạo Sản phẩm (Đã bổ sung costPrice)
        const productsData = [
            // ================= ECO HOME & LIVING =================
            {
                name: 'Bamboo Cutting Board',
        ...
        console.log(`Created ${createdProducts.length} products with costPrice`)

        // 5. Tạo Phiếu nhập hàng mẫu (Purchase Order)
        const sampleProduct = createdProducts[0]
        await PurchaseOrder.create({
            code: 'PN-20260323-0001',
            supplier: suppliers[0]._id,
            items: [{
                product: sampleProduct._id,
                productName: sampleProduct.name,
                quantity: 50,
                importPrice: sampleProduct.costPrice,
                totalPrice: 50 * sampleProduct.costPrice
            }],
            totalAmount: 50 * sampleProduct.costPrice,
            note: 'Đợt nhập hàng đầu kỳ thử nghiệm',
